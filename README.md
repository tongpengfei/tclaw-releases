...
| CLI 启动 | 小红书内容生成 |
|---|---|
| ![CLI](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw01_cli01.png) | ![小红书](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw02_xhs01.png) |

| 股票分析 | 文件浏览器 |
|---|---|
| ![股票](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw03_stock01.png) | ![文件浏览器](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw04_file_browser01.png) |

| 调试日志 | 小程序 |
|---|---|
| ![日志](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw05_log01.png) | ![小程序](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw06_apps01.png) |

| 代码开发 1 | 代码开发 2 |
|---|---|
| ![代码1](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw07_code01.png) | ![代码2](https://github.com/tongpengfei/tclaw-releases/releases/download/v0.0.1/tclaw08_code02.png) |
...
- **轻量无依赖**：单个可执行文件，解压即用，不需要安装 Python / Node 等环境
...
### 第四步：使用小程序
点击左侧「小程序」图标，探索内置工具，或者自己创建一个专属工作流。
