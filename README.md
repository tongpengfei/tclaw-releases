...
这是 tclaw 的核心。你可以用自然语言描述想要的工具，AI 帮你生成一个可以直接跑起来的应用，不用写代码，不用部署。内置了 AI 图片编辑、视频工作室、文件浏览器等应用，也可以随时自己扩展。用 tbrain + tclaw 甚至能开发出完整的游戏，上面的 Idle RPG 就是这么来的。

### 查资料、整理内容

把文章、报告、对话直接粘进来，让 AI 提炼重点、整理结构、翻译内容，不用每次都去开网页版 AI。

### 分析文件和数据

上传 CSV、Excel、PDF 或文本文件，直接问问题，让 AI 帮你找关键数据、生成分析报告。

### 生成网页原型

描述你想要的页面，AI 生成可以直接预览的 HTML，方便验证想法或和别人沟通需求。

### 本地文件管理

内置文件浏览器，浏览、预览、整理本地文件，结合 AI 批量处理文档。
